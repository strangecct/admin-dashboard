...
import avatar from "../data/avatar/avatar.jpg";
...
export const EditorData = () => (
    <div>
        <h3>
            本项目针对变压器有载分接开关电磁暂态仿真建立仿真模型，分析典型绝缘故障与油中气体的关联关系，
            开展有载分接开关多传感量的非侵入式测量方法与故障诊断技术研究，实现变压器有载分接开
            关在线传感与故障预警综合系统应用，研究内容包括：
            （1）变压器有载分接开关正常及缺陷状态下电磁暂态仿真研究。构建有载分接开关电磁暂态
            仿真模型，模拟开关正常运行及故障工况，研究不同条件下恢复电压、电弧、循环电流等参量
            的特征变化。
            （2）有载分接开关典型绝缘故障与油中气体的关联关系研究。研究不同绝缘故障下的油中
            溶解气体特征，建立有载分接开关典型绝缘故障与油中溶解特征气体关联关系。
            （3）有载分接开关多传感量的非侵入式测量方法与故障诊断技术研究。整合振动、声纹、
            电流等多特征信号，研究多源传感器最优布置策略，构建多维度分接开关实时监测系统；
            对采集到的状态信号进行预处理，提取关键特征信息，完善故障指纹库，研究故障诊断技术。
            （4）变压器有载分接开关在线传感与故障预警综合系统研究。集合数据采集、信息处理和
            故障诊断等功能，研制变压器有载分接开关状态在线感知与故障预警系统，并完成现场测试与
            应用。
        </h3>
    </div>
);
